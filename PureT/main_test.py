...
cd /root/autodl-tmp/ByteCaption && PYTHONPATH=/root/autodl-tmp/ByteCaption python PureT/main_test.py --folder PureT/experiments/ByteCaption_XE_openrouter --corrupt_types rbsl --corrupt_level S0 S1 S2 S3 S4 S5 --test_samples 60 --resume -1 --save_eval_images 60 --disable_wandb
"""
