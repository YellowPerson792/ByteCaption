...
Example:
  python tools/plot_batch_corruption_curves.py \
    ...
    --models ByteCaption_XE ByteCaption_XE_blip ByteCaption_XE_git ByteCaption_XE_gpt5.1 ByteCaption_XE_gemini2.5-flash ByteCaption_XE_gemini2.5-flash ByteCaption_XE_claude-haiku-4.5 ByteCaption_XE_qwen ByteCaption_XE_glm\
